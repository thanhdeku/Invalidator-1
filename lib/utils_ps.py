...
_INFO_PATH = "ICSE22_data/data/patch_info/PS_INFO/{}.json"
_IDX2ID_PATH = "ICSE22_data/data/patch_info/139_patches.json"
_INVARIANT_PATCH_PASS = "ICSE22_data/data/raw_invariants/patchsim_139/patches/{}/result_passing.txt"
_INVARIANT_BUG_PASS = "ICSE22_data/data/raw_invariants/patchsim_139/b/{}/{}/result_passing.txt"
_INVARIANT_FIX_PASS = "ICSE22_data/data/raw_invariants/patchsim_139/f/{}/{}/result_passing.txt"
_INVARIANT_PATCH_FAIL = "ICSE22_data/data/raw_invariants/patchsim_139/patches/{}/result_failing.txt"
_INVARIANT_BUG_FAIL = "ICSE22_data/data/raw_invariants/patchsim_139/b/{}/{}/result_failing.txt"
_INVARIANT_FIX_FAIL = "ICSE22_data/data/raw_invariants/patchsim_139/f/{}/{}/result_failing.txt"

##Confidence score
_CF_PATCH_PASS = "ICSE22_data/data/raw_invariants/patchsim_139/patches/{}/result_passing_confidence_score.txt"
_CF_BUG_PASS = "ICSE22_data/data/raw_invariants/patchsim_139/b/{}/{}/result_passing_confidence_score.txt"
_CF_FIX_PASS = "ICSE22_data/data/raw_invariants/patchsim_139/f/{}/{}/result_passing_confidence_score.txt"
_CF_PATCH_FAIL = "ICSE22_data/data/raw_invariants/patchsim_139/patches/{}/result_failing_confidence_score.txt"
_CF_BUG_FAIL = "ICSE22_data/data/raw_invariants/patchsim_139/b/{}/{}/result_failing_confidence_score.txt"
_CF_FIX_FAIL = "ICSE22_data/data/raw_invariants/patchsim_139/f/{}/{}/result_failing_confidence_score.txt"

def read_learning_distance(path = "ICSE22_data/data/syntactic_distance/learning_cf.txt"):
    data = {}
    with open(path, "r") as f:
        for line in f:
            if line.startswith("ICSE18"):
                imp = line.split("\t")
